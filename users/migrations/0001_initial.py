...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating_points', models.IntegerField(default=0, verbose_name='Рейтинговые очки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('algorithm_name', models.CharField(max_length=100, verbose_name='Название алгоритма')),
                ('completed', models.BooleanField(default=False, verbose_name='Завершен')),
                ('best_time', models.FloatField(blank=True, null=True, verbose_name='Лучшее время (сек)')),
