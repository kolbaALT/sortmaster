"""
Django settings for sortmaster project.
...
SECRET_KEY = 'django-insecure-tw3=dst$xf$_s!!ra*5mw(@2bvzbw&0!zu3i4*=ywzf434^k2p'
...
WSGI_APPLICATION = 'sortmaster.wsgi.application'
